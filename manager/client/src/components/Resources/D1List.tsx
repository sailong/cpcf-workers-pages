    ...
    return (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            <h2 className="text-xl font-bold text-gray-200 mb-4 flex items-center gap-2">
                <span className="text-purple-500">🗄️</span> D1 数据库
            </h2>
            <div className="flex gap-2 mb-4">
                ...
                <button
                    ...
                    className="bg-purple-600 hover:bg-purple-500 px-4 py-2 rounded text-sm text-white"
                >
                    创建
                </button>
            </div>
            ...
            {loading ? (
                ...
                <div className="space-y-2">
                    ...
                    {resources.length === 0 && <div className="text-center text-gray-600 text-sm py-4">暂无 D1 数据库</div>}
                </div>
            )}
