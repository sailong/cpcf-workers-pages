    ...
    return (
        <div className="neo-card p-6">
            <h2 className="text-xl font-black text-[var(--text-main)] mb-6 flex items-center gap-2">
                <span className="text-indigo-500">📦</span> KV Storage
            </h2>
            ...
            {loading ? (
                <div className="text-center text-[var(--text-muted)] py-8 font-medium animate-pulse">Loading namespaces...</div>
            ) : (
                <div className="space-y-3">
                    ...
                    {resources.length === 0 && (
                        <div className="text-center py-10 opacity-50">
                            ...
                            <div className="text-[var(--text-muted)] font-medium">No KV namespaces found</div>
                        </div>
                    )}
                </div>
            )}
